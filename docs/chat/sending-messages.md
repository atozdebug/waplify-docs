...
3. Type your message in the **message input** at the bottom
<!-- screenshot: Message input area with send button -->
...
1. In the message input area, look for the **template** option
2. Select an approved template from the list
3. Fill in any variable values if required
...
1. In the message input area, click the **attachment** icon
2. Select the file you want to send (image, video, document, or audio)
...
- Use [Quick Responses](./quick-responses.md) for frequently sent replies to save time
