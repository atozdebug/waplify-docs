...
3. After approval, come back to Waplify and click **Sync Templates** to import it

### Syncing templates from Meta

If you created templates directly on Meta's website, you need to sync them:

1. Go to the **Templates** page in Waplify
2. Click **Sync Templates**
3. Your approved templates will appear in the list, ready to use in campaigns
<!-- screenshot: Synced templates list in Waplify -->
...
No. Approved templates cannot be edited. You need to create a new template with the changes and submit it for approval.
